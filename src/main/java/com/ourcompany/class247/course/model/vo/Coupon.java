...
public class Coupon {
	...
	public Coupon(int couponNum, int memNum, String couponName, int couponDiscount, Date couponEnrollDate,
			Date couponeUsingDate, Date couponEndDate) {
		super();
		...
		this.couponeUsingDate = couponeUsingDate;
	...
	public Date getCouponeUsingDate() {
		return couponeUsingDate;
	}

	public void setCouponeUsingDate(Date couponeUsingDate) {
		this.couponeUsingDate = couponeUsingDate;
	}
	...
	public String toString() {
		return "Coupon [couponNum=" + couponNum + ", memNum=" + memNum + ", couponName=" + couponName
				+ ", couponDiscount=" + couponDiscount + ", couponEnrollDate=" + couponEnrollDate
				+ ", couponeUsingDate=" + couponeUsingDate + ", couponEndDate=" + couponEndDate + "]";
	}
