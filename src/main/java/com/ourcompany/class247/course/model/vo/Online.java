...
//	
	...
	public Online(int onlineNum, int coursePrice, String coaRName, String courseMaterial, int courseMaterialPrice,
			String courseVideoUrl) {
		super();
		this.onlineNum = onlineNum;
		this.coursePrice = coursePrice;
	...
	@Override
	public String toString() {
		return "Online [onlineNum=" + onlineNum + ", coursePrice=" + coursePrice + ", coaRName=" + coaRName
				+ ", courseMaterial=" + courseMaterial + ", courseMaterialPrice=" + courseMaterialPrice
