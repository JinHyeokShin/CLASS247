					...
					<p>
                       ...
                       <!-- insert -->
                      	<c:url value="coBuy2.do" var="coBuy2">
								...
								<c:param name="coursePrice" value="${c.coursePrice+c.courseMaterialPrice }"/>
						</c:url>
                        <button type="button"
						class="genric-btn primary-border radius"
						style="border-radius: 5px; padding: 10px 0px; width: 100%; height: 50px; text-align: center; line-height: 1"
						id="next_btn" onclick="location.href=${ coBuy2 }">다음</button>
                    </nav>
