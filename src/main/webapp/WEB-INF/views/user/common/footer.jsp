            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-6 col-xl-4">
                    <div class="single-footer-widget footer_1">
                        <a href="index.html"> <img src="<c:url value="resources/user/img/logo.png"/>"> </a>
                        <p>
							...
							이태원지원 : 서울특별시 용산구 보광로 73 한국폴리텍제1대학<br>
							울산지원 : 울산광역시 남구 신정2동 1640-6번지 현대스포츠센터2F<br>
							</p>
                    </div>
                </div>
                ...
                <div class="col-xl-8 col-sm-6 col-md-6">
                    <div class="single-footer-widget footer_2">
                        ...
                        <br><br>
                            <p>(주)클래스247 | 대표 신진혁 | 개인정보보호 책임자 신진혁 | 전화번호 : 010-7316-0813 | 제휴/협력 문의 inthejin92@gmail.com <br>
