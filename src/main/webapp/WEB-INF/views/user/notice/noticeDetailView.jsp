...
<body>
	...
	<section class="contact-section section_padding">
		<div class="container">
						<br>
						<h1>${ n.noticeNum }번 공 지 사 항</h1>
						<br>
						<hr>
						<br>
		<table align="center" border="1px solid black" style="width:80%;" align="center">
			<tr style="color:white;background-color:#954CBC;">
				<th width="10%">번호</th>
				<th width="20%">작성자</th>
				<th width="30%">작성된 날짜</th>
				<th width="30%">수정된 날짜</th>
				<th width="10%">조회수</th>
			</tr>
			<tr>
				<td>${ n.noticeNum }</td>
			...
			<tr >
				<td colspan="6" align="left" height="200px" border="0px;">
		...
		<table align="center" style="width:60%;" align="center" cellspacing="0">
			<tr>
				<td><textarea cols="130" rows="3" id="rContent"></textarea></td>
				<td width="15%"><button class="genric-btn primary-border radius" id="rSubmit">등록하기</button></td>
			</tr>
		</table>
		<!-- 댓글 목록 부분-->
					...
					if(data.nrList.length > 0){ // 존재하는 댓글 있음
						$tableBody.html("");
							...
							$.each(data.nrList, function(index, value){
								...
								var $deleteTd = $("<td width='100' align='center'>");
