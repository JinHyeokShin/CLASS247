            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    <div class="main_image">
                        <img class="img-fluid" src="img/detail test.jpeg" alt="">
                    </div>
                    <br>
                    <br>
                        ...
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex">
                                    <p>Trainer’s Name</p>
                                    <span class="color">${ creatorname }</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Available Seats </p>
                                    <span>${ course_current_num }+"/"+${ course_max_num }</span>
                                </a>
                            </li>
							  <li>
                                <a class="justify-content-between d-flex" href="#">
                                    
                                    <span><input type="image" src="img/love1.png" style="background-size: 30px;" alt=""></span>
