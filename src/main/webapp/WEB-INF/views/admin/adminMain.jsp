            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
	                        ...
	                        <div class="col-lg-12">
	                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
	                                    <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
	                                        ...
	                                        <h3>
	                                           <i class="fas fa-users"></i> Allow Creator</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Allow Creator</h2>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('<%= request.getContextPath() %>/resources/admin/images/bg-title-01.jpg');">
                                        <div class="bg-overlay bg-overlay--blue"></div>
                                        <h3>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('<%= request.getContextPath() %>/resources/admin/images/bg-title-02.jpg');">
                                        <div class="bg-overlay bg-overlay--blue"></div>
                                        <h3>
