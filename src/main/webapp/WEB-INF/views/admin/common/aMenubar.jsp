						...
						<div class="header-button">
								...
								<div class="noti__item js-item-menu">
									...
									<div class="mess-dropdown js-dropdown">
										...
										<div class="mess__item">
											<div
												class="<%= request.getContextPath() %>/resources/admin/image img-cir img-40">
												<img
													src="<%= request.getContextPath() %>/resources/admin/images/icon/avatar-06.jpg"
													alt="Michelle Moreno" />
											</div>
											<div class="content">
								...
								<div class="noti__item js-item-menu">
									...
									<div class="email-dropdown js-dropdown">
										...
										<div class="email__item">
											<div class="image img-cir img-40">
												<img
													src="<%= request.getContextPath() %>/resources/admin/images/icon/avatar-05.jpg"
													alt="Cynthia Harvey" />
											</div>
											<div class="content">
												<p>Meeting about new dashboard...</p>
							...
							<div class="account-wrap">
								<div class="account-item clearfix js-item-menu">
									<div class="image">
										<img
											src="<%= request.getContextPath() %>/resources/admin/images/icon/avatar-01.jpg"
											alt="John Doe" />
									</div>
									<div class="content">
